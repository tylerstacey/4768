...
#import "SolarSwage.h" 
#import "SolarSwageViewController.h"

@interface SolarSwageViewController ()  {
...
@implementation SolarSwageViewController
...
- (void)viewDidLoad {
	...
	solarSwage=[[SolarSwageController alloc] init];
